...
musei$BsmtFin.Type.1 <- factor(replace_na(musei$BsmtFin.Type.1, '0'), 
                               levels = c('0', 'Unf', 'LwQ', 'Rec','BLQ', 'ALQ','GLQ'))

### Setting musei$BsmtFin.Type.2 to factor
musei$BsmtFin.Type.2 <- factor(replace_na(musei$BsmtFin.Type.2, '0'), 
                               levels = c('0', 'Unf', 'LwQ', 'Rec','BLQ', 'ALQ', 'GLQ'))
...
formula <- Sale.Price ~ Lot.Area + Gr.Liv.Area + Overall.Qual + Bedroom.AbvGr +
  BsmtFin.Type.1 + Foundation + Condition.1 + Total.Bsmt.SF + Exter.Qual+ Exter.Cond + Lot.Shape
